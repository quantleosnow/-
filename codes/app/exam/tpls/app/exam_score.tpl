            ...
            <div id="result_con">
              ...
              <p class="mb_10">总分：<b class="orange">{x2;$sessionvars['examsessionsetting']['examsetting']['score']}</b>分 合格分数线：<b class="orange">{x2;$sessionvars['examsessionsetting']['examsetting']['passscore']}</b>分 答卷耗时：<b class="orange">{x2;$sessionvars['examsessiontime']}</b>分钟</p>
                  <table width="100%">
                          ...
                          {x2;endtree}
                          <tr>
                            <td colspan="5" align="left">本次考试共<b class="orange">{x2;$allnumber}</b>道题，总分<b class="orange">{x2;$sessionvars['examsessionsetting']['score']}</b>分，您做对<b class="orange">{x2;$allright}</b>道题，得到<b class="orange">{x2;$sessionvars['examsessionscore']}</b>分</td>
                          </tr>
                       </table>
                       <div id="result_btn"><a href="?exam-app-exam-view">查看答案和解析</a><a href="index.php?exam-app-record&ehtype=2">进入我的错题</a></div>
                 </div>
            </div>
            </div>
    	</div>
