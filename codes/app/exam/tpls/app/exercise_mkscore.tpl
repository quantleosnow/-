...
<div id="main">
	...
	<div id="right_760" class="right_760">
    	...
    	<div class="bor_mid">
            ...
            <form action="?exam-app-exercise-makescore" method="post" id="form1" name="form1">
            <div id="exam_paper">
            	<h2 class="page_title">
                	<img src="app/exam/styles/image/qianghuaxunlian_tit.jpg" alt="强化训练" />
                  </h2>
                ...
                <div class="qu_content" onMouseOver="this.className='qu_content_hover'" onMouseOut="this.className='qu_content'">
                    ...
                    <div class="qu_option" onMouseOver="this.className='qu_option_hover'" onMouseOut="this.className='qu_option'">
                        <div id="self_option">【请根据参考答案给出分值】<input type="text" name="score[{x2;v:question['questionid']}]" value=""><span class="ml_10 red font_12">提示：本题共1分，可输入0.5的倍数。</span></div>
                    </div>
                </div>
                {x2;endtree}
                ...
                <div class="qu_content" onMouseOver="this.className='qu_content_hover'" onMouseOut="this.className='qu_content'">
                	...
                	<h3>{x2;v:tid}、{x2;eval: echo html_entity_decode(v:data['question'])}</h3>
                    <div class="qu_option" onMouseOver="this.className='qu_option_hover'" onMouseOut="this.className='qu_option'">
...
$(document).ready(function(){
		...
		$(window).scroll(function() {
		 ...
		 //da.util.sessionStorage.setItem("form1",null);
	});
</script>
</body>
</html>