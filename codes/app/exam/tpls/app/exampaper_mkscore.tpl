...
<div id="main">
	...
	<div id="right_760" class="right_760">
    	...
    	<div class="bor_mid">
            ...
            <form action="?exam-app-exampaper-makescore" method="post" id="form1" name="form1">
            <div id="exam_paper">
            	<h2 class="page_title">
                <img src="app/exam/styles/image/suijikaoshi_tit.jpg" alt="随机考试" />
                </h2>
                ...
                <div class="qu_content" onMouseOver="this.className='qu_content_hover'" onMouseOut="this.className='qu_content'">
                	<h3><span class="float_l">{x2;v:tid}、</span>{x2;realhtml:v:question['question']}</h3>
