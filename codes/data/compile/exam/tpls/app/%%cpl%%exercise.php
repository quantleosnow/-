...
<div id="main">
 ...
 $qid++; ?>
                            <li class="text_in">
                            	<?php echo $quest['questype']; ?>（共<?php echo $this->tpl_var['numbers'][$quest['questid']]; ?>题），选 <input id="question_<?php echo $quest; ?>" type="text" class="exer_amount" name="args[number][<?php echo $quest; ?>]" onChange="javascript:check_num(this);" onBlur="" rel="<?php echo $this->tpl_var['numbers'][$quest]; ?>"/> 题
