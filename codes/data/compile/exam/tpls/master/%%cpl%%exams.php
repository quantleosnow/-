			        ...
			        <tr>
						...
						<td>
							<div class="btn-group">
								...
								<a class="btn ajax" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-exams-del&page=<?php echo $this->tpl_var['page']; ?>&examid=<?php echo $exam['examid']; ?><?php echo $this->tpl_var['u']; ?>" title="删除"><em class="icon-remove"></em></a>
	                    	</div>
						</td>
			        </tr>
			        <?php } ?>
