			...
			<form action="index.php?content-master-contents" method="post">
				<table class="table">
			        <tr>
						...
						<td>
							<input class="input-small datepicker" data-date="<?php echo date('Y-m-d',TIME); ?>" data-date-format="yyyy-mm-dd" type="text" name="search[stime]" size="10" id="stime" value="<?php echo $this->tpl_var['search']['stime']; ?>"/> - <input class="input-small datepicker" data-date="<?php echo date('Y-m-d',TIME); ?>" data-date-format="yyyy-mm-dd" size="10" type="text" name="search[etime]" id="etime" value="<?php echo $this->tpl_var['search']['etime']; ?>"/>
						</td>
						<td>
							关键字：
						</td>
			            	...
			            	<tr>
			                    ...
			                    <td class="actions">
			                    	<div class="btn-group">
										...
										<a class="btn ajax" href="index.php?content-master-contents-del&catid=<?php echo $content['cncatid']; ?>&contentid=<?php echo $content['contentid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="删除"><em class="icon-remove"></em></a>
			                    	</div>
			                    </td>
			                </tr>
			                <?php } ?>
